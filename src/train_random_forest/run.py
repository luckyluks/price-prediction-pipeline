...
def go(args):
    ...
    # Get the train and validation artifact (args.trainval_artifact) and save the returned path
    ...
    artifact = wandb.Artifact(
        ...
        type="model_export",
        description="Pipeline export, containing inference pipeline (preprocessor and model)",
    )
    # Add the dir and log it
    ...
    # Log "r2" and "mae" error as summary
    logger.info(f"Logging model summary (r2={r_squared};mae={mae})")
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    # Create the inference pipeline, containing the preprocessor and the model
    sk_pipe = Pipeline(
        steps=[
